...
namespace TicketShoppingCartMvcUI.Repositories
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<int> AddItem(int ticketId, int qty)
        {
            ...
            try
            {
                ...
                var cartItem = _db.CartDetails
                                  .FirstOrDefault(a => a.ShoppingCartId == cart.Id && a.TicketId == ticketId);
                ...
                else
                {
                    ...
                    cartItem = new CartDetail
                    {
                        ...
                        Quantity = qty,
                        UnitPrice = ticket.Price  // it is a new line after update
                    };
        ...
        public async Task<int> RemoveItem(int ticketId)
        {
            //using var transaction = _db.Database.BeginTransaction();
            string userId = GetUserId();
            try
        ...
        public async Task<bool> DoCheckout(CheckoutModel model)
        {
            ...
            try
            {
                ...
                foreach(var item in cartDetail)
                {
                    ...
                    var stock = await _db.Stocks.FirstOrDefaultAsync(a => a.TicketId == item.TicketId);
                    if (stock == null)
                    {
